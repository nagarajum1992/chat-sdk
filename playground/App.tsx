  ...
  return (
    <ChatComponent
      serverUrl={{
        ...
        webSocketURL:
          "wss://dwyte-gcp-dev.soham.ai/agent-conversation-service/v1/ws/amt/agent-chat?user_id=nagaraju.mandadapu@soham.ai&session_id=nagaraju.mandadapu@soham.ai&agent_id=223",
      }}
      headers={{
